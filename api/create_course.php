...
try {
    ...
    // 7. Insert course into COURSE table
    $stmt = $conn->prepare("
        INSERT INTO COURSE (
            course_title, 
            duration, 
    ...
    if (isset($upload_dir) && file_exists($upload_dir)) {
        // Optional: Remove uploaded files on error
    }
...
// 14. Connection closes automatically
?>