...
try {
    ...
    // Update teacher request status to 'approved'
    $updateRequestQuery = "UPDATE TEACHER_REQUEST SET teacher_status = 'approved' WHERE teacher_request_id = ?";
    ...
    // Update user is_teacher to 1 (true)
    $updateUserQuery = "UPDATE USER SET is_teacher = 1 WHERE user_id = ?";
